...
class paletteFavCollection : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_palette_fav_collection)
        ...
        val result: Call<List<Reaction>> = service.getReaction()
        Toast.makeText(this@paletteFavCollection, credential.id.toString(), Toast.LENGTH_LONG).show()
    ...
    private fun getusuarioData() {
        ...
        val result2: Call<List<Reaction>> = service.getReaction()
        ...
        result.enqueue(object: Callback<List<Palette>> {
            ...
            override fun onFailure(call: Call<List<Palette>>, t: Throwable){
                Toast.makeText(this@paletteFavCollection,"Error", Toast.LENGTH_LONG).show()
            }
                ...
                if (arrayItems != null){
                    ...
                    adapter.setOnItemClickListener(object : CustomAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            val intent = Intent(this@paletteFavCollection, paletteInfo::class.java)
